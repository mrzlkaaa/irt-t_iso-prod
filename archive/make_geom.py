...
from main import PrepCals, logging_decor
...
class Make_geom(PrepCals):
    def __init__(self):
        ...
        self.sample_parts = float(input('Type on how many parts split body: '))
    ...
    def alter_file(self):
        ...
        logger.debug(f'Body "{pattern}" has added in blockfrom line "{self.starting_line}"')
